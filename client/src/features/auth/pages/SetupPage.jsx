...
const SetupPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setServerError(err.response?.data?.message || 'Setup failed. Admin account may already exist.')
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex w-14 h-14 rounded-2xl bg-indigo-600 items-center justify-center mb-4 shadow-lg shadow-indigo-200">
          ...
          <p className="text-sm text-slate-500 mt-1">Create the first Super Admin account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/50 p-8">
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm font-medium text-slate-700">Admin account created!</p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input {...register('full_name')} placeholder="Admin Name"
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input {...register('email')} type="email" placeholder="admin@company.com"
                  className="h-10 px-3 rounded-lg border border-slate-200 text-sm outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400" />
